...
import HdShyna from "@/components/HdShyna.vue";
import carousel from "vue-owl-carousel";
import FootShyna from "@/components/FootShyna.vue";
import RlProduct from "@/components/RlProduct.vue";
export default {
  name: "product",
  components: {
    // HelloWorld,
